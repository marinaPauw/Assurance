...
class Ui_MainWindow(QtWidgets.QTabWidget):
    ...
    def setupUi(self):
        ...
        leftFrame = QtWidgets.QFrame(UploadFrame)
        leftFrame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        leftFrame.setFrameShadow(QtWidgets.QFrame.Raised)
        leftFrame.setStyleSheet("background-color: rgb(192,192,192); margin:5px;")
        

        rightFrame = QtWidgets.QFrame(UploadFrame)
        rightFrame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        rightFrame.setFrameShadow(QtWidgets.QFrame.Raised)
        rightFrame.setStyleSheet("background-color: rgb(192,192,192); margin:5px;")
        ...
        Ui_MainWindow.cpusLabel= QtWidgets.QLabel(leftFrame)
        Ui_MainWindow.cpusTextBox = QtWidgets.QLineEdit(leftFrame)
        Ui_MainWindow.CLOLabel= QtWidgets.QLabel(leftFrame)
        Ui_MainWindow.CLOTextBox = QtWidgets.QLineEdit(leftFrame)
        Ui_MainWindow.CUOLabel= QtWidgets.QLabel(leftFrame)
        Ui_MainWindow.CUOTextBox = QtWidgets.QLineEdit(leftFrame) 
        Ui_MainWindow.RUNButton = QtWidgets.QPushButton(leftFrame)
        ...
        #Widget declaring:
        Ui_MainWindow.SwaMebutton = QtWidgets.QPushButton(rightFrame)
        Ui_MainWindow.SBrowseButton = QtWidgets.QPushButton(rightFrame)
        Ui_MainWindow.Sfiles = QtWidgets.QLabel(rightFrame)
        Ui_MainWindow.SfileList = QtWidgets.QLabel(rightFrame)
        Ui_MainWindow.divisionLabel= QtWidgets.QLabel(rightFrame)
        Ui_MainWindow.divisionTextBox= QtWidgets.QLineEdit(rightFrame)
        Ui_MainWindow.MTLabel= QtWidgets.QLabel(rightFrame)
        Ui_MainWindow.MTTextBox = QtWidgets.QLineEdit(rightFrame)
        Ui_MainWindow.RTLabel= QtWidgets.QLabel(rightFrame)
        Ui_MainWindow.RTTextBox = QtWidgets.QLineEdit(rightFrame)
        Ui_MainWindow.SRUNButton = QtWidgets.QPushButton(rightFrame)
        Ui_MainWindow.iRT = QtWidgets.QRadioButton("iRT")
        Ui_MainWindow.iRTtoleranceLabel =QtWidgets.QLabel(rightFrame)
        Ui_MainWindow.iRTminintensityLabel =QtWidgets.QLabel(rightFrame)
        Ui_MainWindow.iRTminpeptidesLabel =QtWidgets.QLabel(rightFrame)
        Ui_MainWindow.iRTtoleranceTB =QtWidgets.QLineEdit(rightFrame)
        Ui_MainWindow.iRTminintensityTB =QtWidgets.QLineEdit(rightFrame)
        Ui_MainWindow.iRTminpeptidesTB =QtWidgets.QLineEdit(rightFrame)
        rightFrame.textedit =QtWidgets.QTextEdit(readOnly=True)
        Ui_MainWindow.IRTinputFile = None


        #Widget stylesheets:
        Ui_MainWindow.SBrowseButton.setStyleSheet("background-color: rgb(240,240,240);")
        Ui_MainWindow.SwaMebutton.setStyleSheet("background-color: rgb(240,240,240);")
        ...
        #Layout:
        SwaMevbox = QtWidgets.QVBoxLayout(rightFrame)
        SwaMehbox0 = QtWidgets.QHBoxLayout(rightFrame)
        SwaMehbox0.addWidget(Ui_MainWindow.SwaMebutton)
        SwaMevbox.addLayout(SwaMehbox0)
        SwaMehbox1 = QtWidgets.QHBoxLayout(rightFrame)
        SwaMevbox2 = QtWidgets.QVBoxLayout(rightFrame)
        SwaMehboxf = QtWidgets.QHBoxLayout(rightFrame)
        ...
        SwaMehbox2 = QtWidgets.QHBoxLayout(rightFrame)
        ...
        SwaMehbox3 = QtWidgets.QHBoxLayout(rightFrame)
        ...
        SwaMehbox4 = QtWidgets.QHBoxLayout(rightFrame)
        SwaMehbox4.addWidget(Ui_MainWindow.iRT)
        SwaMevbox.addLayout(SwaMehbox4)
        SwaMehbox5 = QtWidgets.QHBoxLayout(rightFrame)
        SwaMehbox5.addWidget(Ui_MainWindow.iRTtoleranceLabel)
        SwaMehbox5.addWidget(Ui_MainWindow.iRTtoleranceTB)
        SwaMevbox.addLayout(SwaMehbox5)
        SwaMehbox6 = QtWidgets.QHBoxLayout(rightFrame)
        ...
        SwaMehbox7 = QtWidgets.QHBoxLayout(rightFrame)
        SwaMehbox7.addWidget(Ui_MainWindow.SRUNButton)
        SwaMehbox7.addWidget(rightFrame.textedit)
        ...
        #clicked.connect
        Ui_MainWindow.QuaMeterbutton.clicked.connect(self.onQuaMeterClicked)
        Ui_MainWindow.SwaMebutton.clicked.connect(self.onSwaMeClicked)
        ...
        Ui_MainWindow.filename.setGeometry(QtCore.QRect(90, 120, 300, 10))
        ...
        chooseLabel = QtWidgets.QLabel(AnalysisFrame)
        ...
        chooseLabel.setText("Choose the analysis you would like to conduct:")
        ...
        Instructionshbox = QtWidgets.QHBoxLayout(UploadFrame)
        ...
        QuaMehbox = QtWidgets.QHBoxLayout(UploadFrame)
        QuaMehbox.addWidget(leftFrame,0)
        QuaMehbox.addWidget(rightFrame,2)
        uploadvbox.addLayout(QuaMehbox)
        hbox7 = QtWidgets.QHBoxLayout(UploadFrame)
        hbox7.addWidget(uploadLabel)
        hbox7.addWidget(Ui_MainWindow.browse)
        hbox7.addWidget(Ui_MainWindow.filename)
        hbox7.addWidget(UploadProgress)
    ...
    def DisableBrowseButtons(self):
        ...
        Ui_MainWindow.SwaMebutton.setEnabled(False)
        Ui_MainWindow.QuaMeterbutton.setEnabled(False)
